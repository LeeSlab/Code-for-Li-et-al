...
setwd("~/Documents/work/20180429_RBC_development_LD/20190910_HiC_hm_terminal_cellCycle_LD_MergeAll/call_compartment/CompartAB_usingHomer/DLR&ICF")
...
MyWriteTab(mergeDLR, 'mergeDLR_allCompartment.csv',sep='\t')
...
# ProR1_B <- MyRead('./DLR_in_compartment/ProR1DLRInProR1.B.bed','ProE R1','DLR')
# ProR1_B$COMP <- 'B'
# ProR2_B <- MyRead('./DLR_in_compartment/ProR2DLRInProR2.B.bed','ProE R2','DLR')
# ProR2_B$COMP <- 'B'
# OrthoR1_B <- MyRead('./DLR_in_compartment/OrthoR1DLRInOrthoR1.B.bed','OrthoE R1','DLR')
# OrthoR1_B$COMP <- 'B'
# OrthoR2_B <- MyRead('./DLR_in_compartment/OrthoR2DLRInOrthoR2.B.bed','OrthoE R2','DLR')
# OrthoR2_B$COMP <- 'B'
# head(ProR1_B)
# 
# ProR1_m <- rbind(ProR1, ProR1_B)
# ProR2_m <- rbind(ProR2, ProR2_B)
# OrthoR1_m <- rbind(OrthoR1, OrthoR1_B)
# OrthoR2_m <- rbind(OrthoR2, OrthoR2_B)
# 
# MyWriteTab(ProR1_m,'ProR1_m.txt',sep='\t')
# MyWriteTab(ProR2_m,'ProR2_m.txt',sep='\t')
# MyWriteTab(OrthoR1_m,'OrthoR1_m.txt',sep='\t')
# MyWriteTab(OrthoR2_m,'OrthoR2_m.txt',sep='\t')
